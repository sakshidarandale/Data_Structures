...
int main()
{
    ...
    Stack<char> *ssobj = new Stack<char>();
    ...
    cout<<"Number of elements in Stack are : "<<ssobj->Count()<<"\n";
    
    cout<<"Return Value of peep is :"<<ssobj->peep()<<"\n";
    
    ssobj->Display();
    
    cout<<"Number of elements in Stack are : "<<ssobj->Count()<<"\n";
    
    cout<<"Popped element is :"<<ssobj->pop()<<"\n";
